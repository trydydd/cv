...
- `Tech` routes to a gallery of resume pages generated by different models from the same source data and prompt (`inputs/resume.yaml` + `inputs/prompt.md`), via `scripts/generate-gallery-page.mjs`.
